...
router.post("/create-puja", verifyToken, upload.single('image'), createNewPuja);
router.get("/get-puja", verifyToken, getAllpuja);
router.get("/get-puja/:id", verifyToken, getOnePuja);
router.post("/update-puja/:id", verifyToken, upload.single('image'), updatingPuja);
...
router.post("/create-deity", verifyToken,upload.single("image"), createDeity);
router.get("/get-deity", getAllDeities);
router.get("/get-deity/:id", getDeityById);
router.post("/update-deity/:id", upload.single("image"), updateDeity);
